class Public::HomesController < ApplicationController
  ...
  def top
    ...
    if member_signed_in?
      ...
      @followers_posts = Post.where(member_id: follows).where(draft_status: false, display_status: true)
      @member_posts = Post.where(member_id: @member).where(draft_status: false, display_status: true)
